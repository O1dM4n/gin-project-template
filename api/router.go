...
import (
	"log"
	cartApi "oldman.study/gin-project-template/api/cart"
	categoryApi "oldman.study/gin-project-template/api/category"
	orderApi "oldman.study/gin-project-template/api/order"
	productApi "oldman.study/gin-project-template/api/product"
	userApi "oldman.study/gin-project-template/api/user"
	"oldman.study/gin-project-template/config"
	"oldman.study/gin-project-template/domain/cart"
	"oldman.study/gin-project-template/domain/category"
	"oldman.study/gin-project-template/domain/order"
	"oldman.study/gin-project-template/domain/product"
	"oldman.study/gin-project-template/domain/user"
	"oldman.study/gin-project-template/utils/database_handler"
	"oldman.study/gin-project-template/utils/middleware"
